...
const drawClassActive = computed(() => {
...
//   // map.on('draw.create', MapStore.drawShapeChange);
...
const handleDrawModeChange = (e) => {
  console.log('MapPanel.vue handleDrawModeChange is running, e:', e, 'e.mode:', e.mode);
...
const handleDeletePointButtonClick = () => {
...
const handleDrawButtonClick = (e) => {
  const MapStore = useMapStore();
  console.log('MbDrawControl.vue handleDrawButtonClick, MapStore.draw:', MapStore.draw);
